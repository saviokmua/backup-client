...
module FtpHelper
  ...
  def upload_dir_ftp(local_folder, destination_folder)
    ::Ftp::Commands::FolderUpload.new(ftp_client, local_folder, destination_folder).call
  end

  def upload_file_ftp(local_file_path, remote_folder_path)
    ::Ftp::Commands::FileUpload.new(ftp_client, local_file_path, remote_folder_path).call
  end
